...
class SNLIClassifier(nn.Module):
    ...
    def forward(self, hypothesis, premise, teacher_prob):
        ...
        if not self.args.teacher or not self.training:
            ...
            hyp_encode, hyp_true, hyp_pred, actions = self.spinn(hyp_embed, hypothesis[1], hypothesis[2], prem_summary, teacher_prob)
        ...
        return output, sent_true, sent_pred, actions
